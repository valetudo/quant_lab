...
FTSEMIB: list[str] = [
    ...
    "BPSO.MI", "CPR.MI", "DIA.MI", "ENEL.MI", "ENI.MI", "ERG.MI", "FBK.MI",
    "G.MI", "HER.MI", "INW.MI", "ISP.MI", "IVG.MI", "LDO.MI", "MB.MI", "MONC.MI",
    "NEXI.MI", "PIRC.MI", "PRY.MI", "RACE.MI", "REC.MI", "SPM.MI", "SRG.MI",
    "STLAM.MI", "STMMI.MI", "TEN.MI", "TIT.MI", "TRN.MI", "UCG.MI", "UNI.MI",
    "BAMI.MI", "BPSO.MI", "BGN.MI", "BMED.MI",
]
...
CAC_LARGE_MID: list[str] = [
    "AC.PA", "AI.PA", "AIR.PA", "ALO.PA", "BN.PA", "BNP.PA", "CA.PA",
    "CAP.PA", "CS.PA", "DG.PA", "DSY.PA", "EL.PA", "EN.PA", "ENGI.PA",
    "ERF.PA", "FR.PA", "GLE.PA", "HO.PA", "KER.PA", "LR.PA", "MC.PA",
    "ML.PA", "OR.PA", "ORA.PA", "PUB.PA", "RI.PA", "RMS.PA", "SAF.PA",
    "SAN.PA", "SGO.PA", "STMPA.PA", "SU.PA", "SW.PA", "TEP.PA", "TTE.PA",
    "URW.PA", "VIE.PA", "VIV.PA", "WLN.PA",
]

# S&P 500 proxy (a curated quality-tilted slice used for quality_stocks dev).
SP500_PROXY: list[str] = [
    "AAPL", "MSFT", "GOOG", "GOOGL", "META", "AMZN", "NVDA", "JNJ", "JPM",
    "V", "PG", "MA", "HD", "UNH", "XOM", "CVX", "PFE", "ABBV", "KO", "PEP",
    "WMT", "MCD", "BAC", "CSCO", "ORCL", "ADBE", "CRM", "INTC", "TXN", "QCOM",
]
